 ...
 * @date 2022/6/26
 */
public class MyBinaryLogClient implements BinaryLogClientMXBean {
    ...
    private final List<MyBinaryLogClient.EventListener> eventListeners = new CopyOnWriteArrayList<MyBinaryLogClient.EventListener>();
    private final List<MyBinaryLogClient.LifecycleListener> lifecycleListeners = new CopyOnWriteArrayList<MyBinaryLogClient.LifecycleListener>();
     ...
     * @see MyBinaryLogClient#MyBinaryLogClient(String, int, String, String, String)
     */
    public MyBinaryLogClient(String username, String password) {
     ...
     * @see MyBinaryLogClient#MyBinaryLogClient(String, int, String, String, String)
     */
    public MyBinaryLogClient(String schema, String username, String password) {
     ...
     */
    public MyBinaryLogClient(String hostname, int port, String schema, String username, String password) {
    ...
    private void connectWithTimeout(final long connectTimeout) throws IOException {
        ...
        try {
            ...
            connected = true;
            for (MyBinaryLogClient.LifecycleListener lifecycleListener : lifecycleListeners) {
    ...
    public void connect(final long timeout) throws IOException, TimeoutException {
        ...
        MyBinaryLogClient.AbstractLifecycleListener connectListener = new MyBinaryLogClient.AbstractLifecycleListener() {
            @Override
            public void onConnect(MyBinaryLogClient client) {
     ...
     */
    public List<MyBinaryLogClient.EventListener> getEventListeners() {
     ...
     * where registered.
     */
    public void registerEventListener(MyBinaryLogClient.EventListener eventListener) {
     ...
     */
    public void unregisterEventListener(Class<? extends MyBinaryLogClient.EventListener> listenerClass) {
        for (MyBinaryLogClient.EventListener eventListener: eventListeners) {
     ...
     */
    public void unregisterEventListener(MyBinaryLogClient.EventListener eventListener) {
        eventListeners.remove(eventListener);
    }
     ...
     */
    public List<MyBinaryLogClient.LifecycleListener> getLifecycleListeners() {
     ...
     * where registered.
     */
    public void registerLifecycleListener(MyBinaryLogClient.LifecycleListener lifecycleListener) {
     ...
     */
    public void unregisterLifecycleListener(Class<? extends MyBinaryLogClient.LifecycleListener> listenerClass) {
        for (MyBinaryLogClient.LifecycleListener lifecycleListener : lifecycleListeners) {
     ...
     */
    public void unregisterLifecycleListener(MyBinaryLogClient.LifecycleListener eventListener) {
    ...
    /**
     * {@link MyBinaryLogClient}'s event listener.
     */
    ...
    /**
     * {@link MyBinaryLogClient}'s lifecycle listener.
     */
    public interface LifecycleListener {
         ...
         */
        void onConnect(MyBinaryLogClient client);

        /**
         * It's guarantied to be called before {@link #onDisconnect(MyBinaryLogClient)}) in case of
         * communication failure.
         */
        void onCommunicationFailure(MyBinaryLogClient client, Exception ex);
         ...
         */
        void onEventDeserializationFailure(MyBinaryLogClient client, Exception ex);

        /**
         * Called upon disconnect (regardless of the reason).
         */
        void onDisconnect(MyBinaryLogClient client);
    }

    /**
     * Default (no-op) implementation of {@link MyBinaryLogClient.LifecycleListener}.
     */
    public static abstract class AbstractLifecycleListener implements MyBinaryLogClient.LifecycleListener {

        @Override
        public void onConnect(MyBinaryLogClient client) { }

        @Override
        public void onCommunicationFailure(MyBinaryLogClient client, Exception ex) { }

        @Override
        public void onEventDeserializationFailure(MyBinaryLogClient client, Exception ex) { }

        @Override
        public void onDisconnect(MyBinaryLogClient client) { }
