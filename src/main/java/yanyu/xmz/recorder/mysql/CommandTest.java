package yanyu.xmz.recorder.mysql;
...
import yanyu.xmz.recorder.mysql.protocol.ConnectionChannel;
import yanyu.xmz.recorder.mysql.protocol.ErrPacket;
import yanyu.xmz.recorder.mysql.protocol.OkPacket;
...
public class CommandTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ConnectionChannel connectionChannel = new ConnectionChannel(hostname, port, username, password);

        try {

            PacketChannel localChannel = connectionChannel.getChanel();
    ...
    private static void authenticate(final PacketChannel channel, GreetingPacket greetingPacket) throws IOException {
        ...
        AuthenticateCommand authenticateCommand = new AuthenticateCommand("mooc", username, password,
